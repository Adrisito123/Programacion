...
public class Calculadora {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("11.Sumar hasta poner 0");
            ...
            switch (opcion) {
                ...
                case 11:
                    sumarInfinito(scanner);
                    break;

                default: // Si el usuario ingresa una opción no válida
                    System.out.println("Opción no válida, por favor ingresa un número entre 1 y 12.");
                    break;
            }
     ...
     public static void factorial(Scanner scanner){
      ...
      public static void multiplicarPorPi(Scanner scanner){
        ...
        System.out.print("Dime un número: ");
          ...
          public static void sumarInfinito(Scanner scanner) {
             double suma = 0;
              double num;
              do {
